...
VioManagerSLG::VioManagerSLG(VioManagerOptionsSLG &params_, TrackSuperLightGlueConfig& slg_config_) : thread_init_running(false), thread_init_success(false) {
...
void VioManagerSLG::feed_measurement_imu(const ov_core::ImuData &message) {
...
void VioManagerSLG::feed_measurement_simulation(double timestamp, const std::vector<int> &camids,
...
void VioManagerSLG::track_image_and_update(const ov_core::CameraData &message_const) {
...
void VioManagerSLG::do_feature_propagate_update(const ov_core::CameraData &message) {
